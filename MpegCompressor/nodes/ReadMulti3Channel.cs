...
namespace MpegCompressor.Nodes {
    class ReadMulti3Channel : Node {
        ...
        private void setupBlobs(DataBlob metadata) {
            ...
            C3.channels = new float[3][];
            V2.channels = new float[3][];
            V3.channels = new float[3][];
            ...
            V3.channels[0] = new float[cMajor];
            V2.channels[1] = new float[cMinor];
            V3.channels[1] = new float[cMinor];
            V2.channels[2] = new float[cMinor];
            V3.channels[2] = new float[cMinor];
        }
